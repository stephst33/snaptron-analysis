---
title: "20190726_sf3b1_mutWT_e622d_ds"
...
SigJcns <- read.delim('../output/snakemake_out_sf3b1_mutWT_e622d_ds/leafcutter.ds.cluster_sig.txt.gz') %>%
...
DifferentialJunctionsList <- read.delim('../output/snakemake_out_sf3b1_mutWT_e622d_ds/leafcutter.ds.effect_sizes.txt.gz', header=T) %>%
...
heatmap.2(Heatmap, col=colorRampPalette(c("blue", "white", "red"))(n = 299), dendrogram="column", trace="none", labRow="", labCol=ColLabel, ColSideColors=RNAExtractionDate, key.title="PSI-Zscore", ylab="14274 splice junctions", xlab="10 samples")
```
