---
title: "20190723_sf3b1_e622d_wt_ds"
...
```{r}
Numers <- '../output/snakemake_out_sf3b1_e622d_wt_ds/CountTableNumerators.gz'
Denoms <- '../output/snakemake_out_sf3b1_e622d_wt_ds/CountTableDenominators.gz'
...
#DifferentialJunctionsList <- read.table('../data/other_snakemake_data/DarmanDiffJunctions.LiftedToHg38.bed', header=F)S
...
Groups <- read.delim("../data/other_snakemake_data/sf3b1_e622d_wt_ds.groups.txt", header=F)
...
heatmap.2(Heatmap, col=colorRampPalette(c("blue", "white", "red"))(n = 299), dendrogram="column", trace="none", labRow="", labCol=ColLabel, ColSideColors=RNAExtractionDate, key.title="PSI-Zscore", ylab="157 splice junctions", xlab="10 samples")
```
