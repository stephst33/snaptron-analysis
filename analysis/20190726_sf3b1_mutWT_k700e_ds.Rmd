...
write.table(effect_sizes_bed,file="../data/other_snakemake_data/effect_sizes.bed.gz",quote=FALSE, row.names=FALSE,col.names=FALSE,sep="\t")
...
system("../code/SubSnakemakeWorkflow/scripts/AnnotateSplicingType.py -I ..data/other_snakemake_data/effect_sizes.bed.gz -A ..data/other_snakemake_data/GencodeHg38_all_introns.bed.gz  -O ..data/other_snakemake_data/effect_sizes_annotated.bed.gz")
